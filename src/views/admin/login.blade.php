...
<div class="logo">
    <a href="index.html">
        <img src="{{{ asset('packages/chrisbjr/kitchen/assets/admin/layout/img/logo-big.png') }}}" alt=""/>
    </a>
</div>
<!-- END LOGO -->
...
<div class="form-group">
<label class="control-label visible-ie8 visible-ie9" for="country">Country</label>
